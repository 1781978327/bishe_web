...
TRACKER_REID_MODEL=/home/orangepi/Desktop/web/bishebeifen-master/yolov8-rk3588-cpp-3-15/model/RK3588/osnet_x0_25_market.rknn \
./rknn_http_ctrl
```
...
```bash
curl -X POST "$BASE/api/inference/on?track=1&tracker=bytetrack&model=/home/orangepi/Desktop/web/bishebeifen-master/yolov8-rk3588-cpp-3-15/model/RK3588/yolov8s.rknn"
curl -X POST $BASE/api/rtsp/start
```
...
```bash
curl -X POST "$BASE/api/inference/on?track=1&tracker=deepsort&tracker_skip=2&model=/home/orangepi/Desktop/web/bishebeifen-master/yolov8-rk3588-cpp-3-15/model/RK3588/yolov8s.rknn&reid_model=/home/orangepi/Desktop/web/bishebeifen-master/yolov8-rk3588-cpp-3-15/model/RK3588/osnet_x0_25_market.rknn"
curl -X POST $BASE/api/rtsp/start
```
...
```bash
cd /home/orangepi/Desktop/web/bishebeifen-master/yolov8-rk3588-cpp-3-15/build_release
./rknn_yolov8_demo /home/orangepi/Desktop/web/bishebeifen-master/yolov8-rk3588-cpp-3-15/model/RK3588/yolov8s.rknn
```
